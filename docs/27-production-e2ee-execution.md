...
The multi-device model follows the Signal Sesame design principle that each physical device has its own identity/session state and that asynchronous delivery must tolerate offline devices, reordering, duplication and state loss. citeturn0view0
